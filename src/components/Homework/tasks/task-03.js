...
// //task-0: Create a helper function and then Create a react solution that
...
const solution = {
  ...
  summary:
    "task-0: Create a helper function and then Create a react solution that would have a function as a property as well as something else be it a string, number or object. Have your custom function consume the other property in some way within your soultion",
  item: <Render />,
};
